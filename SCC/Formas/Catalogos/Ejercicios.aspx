<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="Ejercicios.aspx.cs" Inherits="SCC.Formas.Catalogos.Ejercicios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function fnc_Nuevo() {
             ...
             $("#ContentPlaceHolder1_radioStatus_0").prop('checked', 'checked');
                                ...
                                <asp:GridView ID="gridEjercicios" OnRowDataBound="gridEjercicios_RowDataBound" OnPageIndexChanging="gridEjercicios_PageIndexChanging" ShowHeaderWhenEmpty="true" DataKeyNames="Id" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Año" SortExpression="Año">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "Año")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Factor IVA" SortExpression="Año">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "FactorIva")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Status" SortExpression="Año">
                                            <ItemTemplate>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Año:</label>
                                    <input type="number" name="prueba" runat="server" class="form-control campoNumerico" id="txtAnio" />
                                </div>

                                <div class="form-group">
                                    <label>Factor IVA:</label>
                                    <input type="text" name="prueba" runat="server" class="form-control campoNumerico" id="txtFactor" />
                                </div>

                                <div class="form-group">
                                    <label>Status:</label>
                                    <asp:RadioButtonList runat="server" ID="radioStatus">
