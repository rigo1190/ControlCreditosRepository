<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="Departamento.aspx.cs" Inherits="SCC.Formas.Catalogos.Departamento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fnc_Validar() {
            ...
            if (!valido) {
                $("#<%=lblMsgError.ClientID %>").text("Los datos de Descripción y Clave no pueden ir vacíos. Intente de nuevo");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-success alert-dismissable">
                        <h4><i class="fa fa-crosshairs"></i> <strong>Catálogo de Departamentos</strong></h4>  
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h3 class="panel-title"><i class="fa"></i> Lista de Deparamentos</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <asp:GridView ID="gridDeptos" OnRowDataBound="gridDeptos_RowDataBound" OnPageIndexChanging="gridDeptos_PageIndexChanging" ShowHeaderWhenEmpty="true" DataKeyNames="Id" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Unidade Presupuestal" SortExpression="Año">
                                            <ItemTemplate>
            ...
            <div class="row" style="display:none" runat="server" id="divCaptura" >
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa"></i>Datos del Departamento</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlUnidades" CssClass="form-control"></asp:DropDownList>
                                </div>
    ...
    <div runat="server" style="display:none">
        <input type="hidden" runat="server" id="_IDDepto" />
