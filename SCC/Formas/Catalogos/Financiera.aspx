<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="Financiera.aspx.cs" Inherits="SCC.Formas.Catalogos.Financiera" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-success alert-dismissable">
                        <h4><i class="fa fa-crosshairs"></i> <strong>Catálogo de Financieras</strong></h4>  
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h3 class="panel-title"><i class="fa"></i> Lista de Financieras</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <asp:GridView ID="gridFinancieras" OnRowDataBound="gridFinancieras_RowDataBound" OnPageIndexChanging="gridFinancieras_PageIndexChanging" ShowHeaderWhenEmpty="true" DataKeyNames="Id" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false" >
                                    <Columns>
            ...
            <div class="row" style="display:none" runat="server" id="divCaptura" >
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa"></i>Datos de la Financiera</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-12">
    ...
    <div runat="server" style="display:none">
        <input type="hidden" runat="server" id="_IDFinanciera" />
