<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="SCC.Formas.Catalogos.Usuarios" %>
    ...
    <div class="container">
                            ...
                            <div class="col-lg-12">
                                <asp:GridView ID="gridUsuarios" OnRowDataBound="gridUsuarios_RowDataBound" OnPageIndexChanging="gridUsuarios_PageIndexChanging" ShowHeaderWhenEmpty="true" DataKeyNames="Id" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rol" SortExpression="Año">
                                            <ItemTemplate>
            ...
            <div class="row" style="display:none" runat="server" id="divCaptura" >
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa"></i>Datos del Usuario</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-12">
